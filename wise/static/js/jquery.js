...
jQuery.extend({
	...
	style: function( elem, name, value, extra ) {
        ...
        if ( namespace && namespace.indexOf("MathML") > -1 ) {
            ...
            if( value == null ) {
               delete elem.cssProps[name]; 
            }

            if( elem.cssProps.length == 0 ) {
                elem.removeAttribute('style');
                return;
            }

			for ( var style in elem.cssProps ) {
                styleline += style + ':' + elem.cssProps[style] + ';';
			}

            elem.setAttribute('style', styleline);
            elem.style = elem.cssProps;
        }
